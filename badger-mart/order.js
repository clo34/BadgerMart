...
function calculateSubtotal() {
	...
	return total || 0.00; // TODO calculateSubtotal
}

function calculateSalesTax() {
	const subtotal = calculateSubtotal();
	const salesTax = subtotal * getSalesTaxRateForState(document.getElementById("state-tax").value);
	return roundMoney(salesTax) || 0.00; // TODO calculateSalesTax
}

function getSalesTaxRateForState(state) {

	return SALES_TAX[state] || 0.00; // TODO getSalesTaxRateForState
}
